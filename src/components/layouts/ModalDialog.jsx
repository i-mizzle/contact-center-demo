    ...
    <Transition appear show={shown} as={Fragment}>
      ...
      >
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <div
              className={`inline-block w-full ${maxWidthClass || ''} p-6 my-8 text-left border border-transparent dark:border-stone-900/50 align-middle transition-all transform bg-white dark:bg-stone-950 shadow-xl rounded-lg `}
            >
